...
make_features <- function(Ek = '', El = '', Fun ='count'){
       qry <- c()
       entity_realations <- find_relation()
       entityLoop <- 1
       ...
       while(entityLoop == 1){
              ...
              while(d >= 0){
                     ...
                     for (i in dbListFields(mydb,relatedVal[d+1]))
                     {
                            if (i  %in% get_idies()){}
                            else{
                                   ...
                                   print(paste("relation between", h, z, ": ", relation))
                                   rm(h);rm(z)
...
dfeat <- function(Ek, El, relatedFeature, k, d=0){
...
dfeat1 <- function(Ek, El, relatedFeature, k){
